...
public class BookUserCF {
    ...
    public BookUserCF(Map<Integer, Integer> userItemLength, Map<Integer, Set<Integer>> itemUserCollection, Set<Integer> items, Integer recommendUser) {
    ...
    public ArrayList<Integer> UserCF(){
        ...
        while(books.size()<10){
            ...
            List<Book> book = bookDao.selectTop();
            for(int i = 0 ; i < book.size();i++){
                books.add(book.get(i).getId());
            }
        }
        return books;
    }
