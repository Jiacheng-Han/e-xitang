...
public class WangkeUserCF {
    ...
    public WangkeUserCF(Map<Integer, Integer> userItemLength, Map<Integer, Set<Integer>> itemUserCollection, Set<Integer> items,Integer recommendUser) {
    ...
    public ArrayList<Integer> UserCF(){
        ...
        if(this.userItemLength.get(recommendUser)!=null){
            ...
            Map<Integer, Double> sortMap = sortMap(result);//根据推荐度排序
        ...
        while(videos.size()<9){
            ...
            videos.addAll(videoDao.selectTOP(9-videos.size()));
        }
        return videos;
    }
